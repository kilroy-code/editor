...
describe('Editing', function () {
  ...
  describe('browser', function () {
    describe('nodes can compareDocumentPosition', function () { // Just a smoke test that the method exists and does something.
      it('for proceeding node.', function () {
      ...
      it('for following node.', function () {
...
<div id="outerContainer">
   ...
   <a id="afterContainer">zz</a>
    ...
    describe('toggle inline formatting', function () {
      describe('on', function () {
        ...
        //   The the entire word is toggled to the opposite of the character to the left of the caret, with the caret left within the new formatting so that future characters match.
        // If the collpased caret is at the start of a word, Pages still looks to the left of the caret, but the opposite formatting applies to new text inserted between caret and the word start.
        describe('wraps around the text of a non-empty selection', function () {
          it('that is all text.', function () {
          ...
          it('immediately around each text-node of a mixed format selection.', function () {
        ...
        xdescribe('in collapsed selections', function () {
        ...
        xdescribe('collapsed leaves caret immediately in new element', function () {
          it('at start.', function () {
            editor.selection.setBaseAndExtent(content, 0, content, 0);
            editor.toggle('X');
